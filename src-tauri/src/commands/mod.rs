...
pub use engine::{
    ...
    engine_stop, engine_uninstall_helper, reconcile_persisted_state, reconcile_stale_runtime,
    spawn_engine_health_monitor, spawn_traffic_reporter, spawn_traffic_sampler,
    auto_connect_on_startup, EngineAppState,
};
