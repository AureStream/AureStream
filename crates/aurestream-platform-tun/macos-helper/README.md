...
```
crates/aurestream-plugin-privilege/macos-helper/
...
Build and sign via `pnpm pre-bundle` (`scripts/prebundle.ts` → `src-tauri/target/helper/com.root.aurestream.helper`).
